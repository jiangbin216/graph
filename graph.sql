...
-- ----------------------------
-- Table structure for graph_domain
-- ----------------------------
DROP TABLE IF EXISTS `graph_domain`;
...
-- ----------------------------
-- Table structure for node_detail
-- ----------------------------
...
-- ----------------------------
-- Table structure for node_detail_file
-- ----------------------------
DROP TABLE IF EXISTS `node_detail_file`;
CREATE TABLE `node_detail_file` (
  `ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '领域关系主键',
  `DomainId` int(11) DEFAULT NULL COMMENT '知识图谱领域主键',
  `NodeId` int(11) DEFAULT NULL COMMENT '关系定义主键',
